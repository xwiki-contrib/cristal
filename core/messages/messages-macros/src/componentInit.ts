...
import { ErrorMacro } from "./macros/errorMacro";
...
export class ComponentInit {
  constructor(container: Container) {
    container
      ...
      .to(eraseParamsTypeForMacroClass(InfoMacro));

    container
      .bind<MacroWithUnknownParamsType>("Macro")
      .to(eraseParamsTypeForMacroClass(WarningMacro));

    container
      .bind<MacroWithUnknownParamsType>("Macro")
      .to(eraseParamsTypeForMacroClass(ErrorMacro));

    container
      .bind<MacroWithUnknownParamsType>("Macro")
      .to(eraseParamsTypeForMacroClass(SuccessMacro));
  }
}
