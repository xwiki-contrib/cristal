...
/**
 * Implementation of the success macro
 *
 * @since 0.24-rc-1
 * @beta
 */
@injectable()
export class SuccessMacro implements BlockMacro<MacroParams> {
  readonly infos: MacroInfos<MacroParams> = {
    id: "success",
    name: "Box for a success message",
    description: "Block showing a success message",
    params: macroParams,
    paramsDescription: {},
    defaultParameters: {},
    bodyType: "wysiwyg",
...
const CSS_CLASS_NAME = "cristal-macro-success-box";
