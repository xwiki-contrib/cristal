...
// @beta (undocumented)
export type BlockOfType<B extends BlockType["type"]> = Extract<
  BlockType,
  {
    type: B;
  }
...
// @beta (undocumented)
export type EditorBlockSchema =
  EditorSchema extends BlockNoteSchema<infer BlockSchema, infer _, infer __>
    ? BlockSchema
    : never;

// @beta (undocumented)
export type EditorInlineContentSchema =
...
// @beta (undocumented)
export type EditorStyleSchema =
  EditorSchema extends BlockNoteSchema<infer _, infer __, infer StyleSchema>
    ? StyleSchema
    : never;
...
// @beta
export function querySuggestionsMenuItems(
  editor: EditorType,
  query: string,
  macros: BlockNoteConcreteMacro[],
